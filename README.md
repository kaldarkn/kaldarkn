<div align="center">
    ...
    <a href="https://metanit.com/web/html5/1.1.php">
        <img src="https://icons8.ru/icon/N1Dl0KKHixwS/html.png" title="HTML"/>
    </a>
...
Также принимал участие в трехдневном хакатоне BlackBox в качестве Frontend-разработчика (React), где вместе с командой выполняли кейс от Самоката. Заняли призовое третье место. 
